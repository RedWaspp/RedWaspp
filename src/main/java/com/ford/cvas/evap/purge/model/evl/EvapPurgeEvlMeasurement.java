...
@Entity(name = "EVAP_PURGE_EVL")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EvapPurgeEvlMeasurement extends EvapPurgeMeasurement {
    ...
    private EvapEvlVehicle vehicle;

    public EvapPurgeEvlMeasurement(EvapEvlVehicle vehicle,
