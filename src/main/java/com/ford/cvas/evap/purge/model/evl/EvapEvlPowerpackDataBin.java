...
@Entity(name = "EVAP_EVL_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapEvlPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapEvlPowerpackDataBin(EvapEvlPowerpackData powerpackData,
