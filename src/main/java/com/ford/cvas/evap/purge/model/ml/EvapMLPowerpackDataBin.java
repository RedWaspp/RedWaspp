...
@Entity(name = "EVAP_ML_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapMLPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapMLPowerpackDataBin(EvapMLPowerpackData powerpackData,
