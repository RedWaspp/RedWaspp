...
@Entity(name = "EVAP_EONV_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapEonvPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapEonvPowerpackDataBin(EvapEonvPowerpackData powerpackData,
