...
@Entity(name = "EVAP_VKONSCT_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapVkonsctPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapVkonsctPowerpackDataBin(EvapVkonsctPowerpackData powerpackData,
