...
@Entity(name = "EVAP_KOBL_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapKoblPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapKoblPowerpackDataBin(EvapKoblPowerpackData powerpackData,
