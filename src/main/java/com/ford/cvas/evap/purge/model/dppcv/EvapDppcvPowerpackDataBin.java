...
@Entity(name = "EVAP_DPPCV_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapDppcvPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapDppcvPowerpackDataBin(EvapDppcvPowerpackData powerpackData,
