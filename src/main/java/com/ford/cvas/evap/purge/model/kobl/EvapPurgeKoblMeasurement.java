...
@Entity(name = "EVAP_PURGE_KOBL")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EvapPurgeKoblMeasurement extends EvapPurgeMeasurement {
    ...
    private EvapKoblVehicle vehicle;

    public EvapPurgeKoblMeasurement(EvapKoblVehicle vehicle, Double value, Double nonNormalizedValue, Double nonNormalizedMaxLimit, Double nonNormalizedMinLimit, LocalDateTime time, Integer timeInService, Integer odometer, Integer odometerInKilometer, Integer warningStatusMis, Integer warningStatusTis, Boolean processed) {
