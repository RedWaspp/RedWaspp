...
@Entity(name = "EVAP_PURGE_VBVP")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EvapPurgeVbvpMeasurement extends EvapPurgeMeasurement {
    ...
    private EvapVbvpVehicle vehicle;

    public EvapPurgeVbvpMeasurement(EvapVbvpVehicle vehicle,
