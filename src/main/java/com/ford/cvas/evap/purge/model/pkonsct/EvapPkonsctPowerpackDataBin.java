...
@Entity(name = "EVAP_PKONSCT_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapPkonsctPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapPkonsctPowerpackDataBin(EvapPkonsctPowerpackData powerpackData,
