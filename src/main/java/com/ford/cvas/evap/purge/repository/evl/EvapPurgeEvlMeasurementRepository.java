...
@Repository
public interface EvapPurgeEvlMeasurementRepository extends JpaRepository<EvapPurgeEonvMeasurement, Integer> {
    ...
    @Query("select new com.ford.cvas.evap.purge.model.dto.EvapPurgeMeasurementDTO(" +
        ...
        "m.vehicle.fuelTypeCategory,m.vehicle.orderTypeCategory,m.vehicle.vin,m.warningStatusMis, m.units,'EVL',m.vehicle.powerpackData.id) " +
            "from EVAP_PURGE_EVL m where " +
