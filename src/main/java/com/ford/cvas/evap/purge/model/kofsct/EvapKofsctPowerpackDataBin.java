...
@Entity(name = "EVAP_KOFSCT_POWERPACK_DATA_BIN")
@NoArgsConstructor
@Data
public class EvapKofsctPowerpackDataBin implements PowerpackDataBin {
    ...
    public EvapKofsctPowerpackDataBin(EvapKofsctPowerpackData powerpackData,
